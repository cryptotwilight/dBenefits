          ...
          <Box p={4}>
            ...
            <Grid container spacing={3}>
              <Grid sm item>
                ...
                Request Gas Free Transaction Allowance
                </Button>
              </Grid>
              <Grid sm item>
                  <Typography variant="h4">Remaining Gas Free Transactions </Typography>
                ...
                >
                  ...
                  <ListItem disableGutters>
                    <ListItemAvatarWrapper>
                      <img
                        alt="ETH"
                        src="/static/images/placeholders/logo/bus.png"
                      />
                    </ListItemAvatarWrapper>
                    <ListItemText
                      primary="Transport"
                    ...
                    />
                    <Box>
                      <Typography align="right" variant="h4" noWrap>3
                        30%
                      </Typography>
